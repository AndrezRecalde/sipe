        ...
        <ul id="sidebar-menu" class="sidebar-menu">
            ...
            foreach ($sidebar_menu as $main_menu) {
                if (isset($main_menu["name"])) {
                    ...
                    if (isset($main_menu["is_custom_menu_item"])) {
                        if ($main_menu['language_key']) {
                            $main_menu_name = app_lang($main_menu['language_key']);
                        } else {
                            $main_menu_name = $main_menu['name'];
                        }
                    } else {
                        $main_menu_name = app_lang($main_menu['name']);
                    }
                    ...
                    <li class="<?php echo $active_class . " " . $expend_class . " " . $submenu_open_class . " "; ?> main">
                        <a <?php echo $target; ?> href="<?php echo isset($main_menu['is_custom_menu_item']) ? $main_menu['url'] : get_uri($main_menu['url']); ?>">
                            ...
                            <span class="menu-text <?php echo isset($main_menu['custom_class']) ? $main_menu['custom_class'] : ""; ?>"><?php echo $main_menu_name; ?></span>
                            <?php
                            if ($badge) {
                        ...
                        if ($submenu) {
                            ...
                            foreach ($submenu as $s_menu) {
                                if (isset($s_menu["is_custom_menu_item"])) {
                                    if ($s_menu['language_key']) {
                                        $s_menu_name = app_lang($s_menu['language_key']);
                                    } else {
                                        $s_menu_name = $s_menu['name'];
                                    }
                                } else {
                                    $s_menu_name = app_lang($s_menu['name']);
                                }
